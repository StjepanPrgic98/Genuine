...
<section>
    <div class="relative flex items-top justify-center sm:items-center py-1 sm:pt-0">
        @if (Route::has('login'))
            <div class="hidden top-0 right-0 px-2 py-2 sm:block items-right">
                @auth
                    <a href="{{ url('/dashboard') }}" class="btn btn-dark text-sm text-white dark:text-gray-500 underline">Dashboard</a>
                @else
                    <a href="{{ route('login') }}" class="btn btn-dark text-sm text-white dark:text-gray-500 underline">Log in</a>

                    @if (Route::has('register'))
                        <a href="{{ route('register') }}" class="btn btn-dark text-sm text-white dark:text-gray-500 underline">Register</a>
                    @endif
                @endauth
            </div>
        @endif
    ...
    <header class="masthead text-white text-center">
        <div class="container d-flex align-items-center flex-column">
            ...
            <!-- Masthead Heading-->
            <h1 class="masthead-heading text-uppercase mb-0">Genuine</h1>
            <!-- Icon Divider-->
            ...
            <!-- Masthead Subheading-->
            <p class="masthead-subheading font-weight-light mb-0">2023 Dating App</p>
        </div>
    </header>
            <!-- Portfolio Section-->
    <section class="page-section portfolio" id="portfolio">
        <div class="container">
            ...
            <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">Most Popular Profiles</h2>
            <!-- Icon Divider-->
                ...
                <div class="col-md-6 col-lg-4 mb-5">
                    <a href="profiles/1">
                        <div class="profile-card-6">
                            <img src="{{ asset('images/moametal.jpg') }}" class="img img-responsive profile_pic"></a>
        ...
        <div class="col-md-6 col-lg-4 mb-5">
            <a href="profiles/10">
                <div class="profile-card-6">
                    <img src="{{ asset('images/lindsey.jpg') }}" class="img img-responsive profile_pic"></a>
        ...
        <div class="text-center mt-4">
            <a class="btn btn-xl btn-outline-dark" href="/profiles">
                Browse Profiles
            </a>
        </div>
        </div>
            ...
            <section class="page-section bg-primary text-white mb-0" id="about">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-4 ms-auto"><p class="lead">The only dating site that helps men effortlessly attract women in their life!</p></div>
                        <div class="col-lg-4 me-auto"><p class="lead">You can create your profile, submit it for review with our Dating experts, and receive feedback on improvements necessary to make your profile as attractive as possible!</p></div>
                    </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            ...
                            <a class="btn btn-outline-light btn-social mx-1" href="https://www.facebook.com/fpmoz.ba/?locale=hr_HR"><i class="fab fa-fw fa-facebook-f"></i></a>
                            <a class="btn btn-outline-light btn-social mx-1" href="https://twitter.com/sve_mostar"><i class="fab fa-fw fa-twitter"></i></a>
                            <a class="btn btn-outline-light btn-social mx-1" href="https://fpmoz.sum.ba/"><i class="fab fa-fw fa-dribbble"></i></a>
                        </div>
                    </div>
                </div>
            </footer>
            ...
            <div class="copyright py-4 text-center text-white">
                <div class="container"><small>Copyright &copy; Genuine 2023</small></div>
            </div>
