  ...
  "stringMap":[ {
    ...
    <section class="page-section portfolio" id="portfolio">
        <div class="container">
            ...
            <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">Dating Expert</h2>
            <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0 mt-5">{{Auth::user()->name}}</h2>
            <!-- Icon Divider-->
