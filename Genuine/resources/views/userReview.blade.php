...
<section class="page-section portfolio" id="portfolio">
    <div class="container">
        ...
        <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">Info from Dating Expert</h2>
        @foreach ($userReviews as $review)
            @if ($review->receiver_id == $user->id)
            <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0 mt-5">{{$review->info}}</h2>
            @endif
        @endforeach
