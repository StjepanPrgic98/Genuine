                ...
                <div class="profile-card-4 z-depth-3">
                    <div class="card">
                        <div class="card-body text-center bg-primary rounded-top">
                            <div class="user-box">
                                <img src="/storage/{{$r->image}}" alt="user avatar" style="height: 130px">
                            </div>
                            <h5 class="mb-1 text-white">{{$r->name}}</h5>
                            <h6 class="text-light">{{$r->job}}</h6>
                        </div>
                        <div class="card-body">
                            <ul class="list-group shadow-none">
                                ...
                                <li class="list-group-item">
                                    <div class="list-icon">
                                        <i class="fab fa-fw fa-facebook-f"></i></i>
                                    </div>
                                    <div class="list-details">
                                        <span>{{$r->facebook}}</span>
                        ...
                        <div class="tab-content p-3">
                            <div class="tab-pane active show" id="profile">
                                ...
                                <div class="row text-center">
                                    ...
                                    <div class="col-md-12">
                                        <h5 class="mt-2 mb-3"><span class="fa fa-clock-o ion-clock float-right"></span>Your reviews</h5>
                                        <table class="table table-hover table-striped">
                                            <tbody>
                                            @foreach($userReviews as $review)
                                                @if ($review->receiver_id == $user->id)
                                                <tr>
                                                    <td>
                                                        <strong>{{$review->info}}</strong><p style="font-size: smaller">{{$review->created_at}}</p>
                                                    </td>
                                                </tr>
                                                @endif
                                            @endforeach
